namespace dotless.Core.Parser.Infrastructure
{
    ...
    public interface INodeProvider
    {
        ...
        //directives
        Import Import(string currentPath, Url path, IImporter importer, Value features, bool isOnce, NodeLocation location);
        Import Import(string currentPath, Quoted path, IImporter importer, Value features, bool isOnce, NodeLocation location);
