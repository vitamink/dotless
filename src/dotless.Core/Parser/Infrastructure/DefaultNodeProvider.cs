namespace dotless.Core.Parser.Infrastructure
{
    ...
    public class DefaultNodeProvider : INodeProvider
    {
        ...
        public Import Import(string currentPath, Url path, IImporter importer, Value features, bool isOnce, NodeLocation location)
        {
            return new Import(currentPath, path, importer, features, isOnce) { Location = location };
        }
